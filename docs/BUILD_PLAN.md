...
**Status:** Active build – M3 complete (synth scaffolding)  
...
| M4 OpenAlgo Paper | Next | Hosted strategy wrapper + paper sink |
...
Proceed to **M4 – OpenAlgo paper path** (engine hosted as Python strategy).
