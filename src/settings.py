...
SYMBOLS_RAW = _s("MERIDIAN_SYMBOLS", "INFY,HCLTECH,RELIANCE,TCS,BTCUSDT,ETHUSDT,BNBUSDT")
...
# minutes_to_eod already counts down to 15:15 IST. Flatten at/after that clock.
EOD_FLATTEN_MIN = _f("MERIDIAN_EOD_FLATTEN_MIN", 0.0)
